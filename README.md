...
Reads the top-N (default: 40 (ref: https://docs.rosettacommons.org/docs/latest/getting_started/Analyzing-Results, ) models per group, sorted by the Score column. 
